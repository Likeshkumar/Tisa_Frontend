...
@Component({
  selector: 'app-auth-receive-cards-pers',
  templateUrl: './auth-receive-cards-pers.component.html',
  styleUrls: ['./auth-receive-cards-pers.component.scss']
})

export class AuthReceiveCardsPersComponent implements OnInit {
  ...
  getbatchlist() {
    ...
    this.rest.postValidate(reqData, url).subscribe((res: any) => {
      if (res.respCode == '00') {
        ...
        this.spinner.hide();
        this.alerts.errorAlert(res.respDesc, 'Batch List Details');
