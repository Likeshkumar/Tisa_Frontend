...
@Component({
  selector: 'app-issuance-of-cards-pers',
  templateUrl: './issuance-of-cards-pers.component.html',
  styleUrls: ['./issuance-of-cards-pers.component.scss'],
  providers: [DatePipe]
})


export class IssuanceOfCardsPersComponent implements OnInit {
  ...
  getFilterRecordList() {
    ...
    let url = 'issuance/get/card-list';
