...
@Component({
  selector: 'app-pre-generation-pers',
  templateUrl: './pre-generation-pers.component.html',
  styleUrls: ['./pre-generation-pers.component.scss'],
  providers: [DatePipe]
})


export class PreGenerationPersComponent implements OnInit {
