...
@Component({
  selector: 'app-acknowledge-in-head-office',
  templateUrl: './acknowledge-in-head-office.component.html',
  styleUrls: ['./acknowledge-in-head-office.component.scss'],
  providers: [DatePipe]
})

export class AcknowledgeInHeadOfficeComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'prodCode', 'branchCode', 'chnCount','typeOfCard', 'deadLine', 'remarks', 'seveity'];
  ...
  generatecvv() {
    if (this.selection.selected.length == 0) {
      ...
      let url = 'stock/acknowledge/stock';
  ...
  reject() {
    if (this.selection.selected.length == 0) {
      ...
      let url = 'stock/acknowledge/reject';
      this.rest.postValidate(reqcvvgenerate, url).subscribe((res: any) => {
