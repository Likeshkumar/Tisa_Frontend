...
@Component({
  selector: 'app-view-account-sub-type',
  templateUrl: './view-account-sub-type.component.html',
  styleUrls: ['./view-account-sub-type.component.scss'],
  providers: [MatBottomSheet, MatButtonModule]
})

export class ViewAccountSubTypeComponent implements OnInit {
