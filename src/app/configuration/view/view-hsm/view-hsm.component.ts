...
@Component({
  selector: 'app-view-hsm',
  templateUrl: './view-hsm.component.html',
  styleUrls: ['./view-hsm.component.scss'],
  providers: [MatBottomSheet, MatButtonModule]
})


export class ViewHsmComponent implements OnInit {
  ...
  InitForm() {
    this.hsmform = this.fb.group({
      ...
      cvk1: ['', [Validators.pattern('^[a-zA-Z0-9]*$'), Validators.minLength(16), Validators.maxLength(16)]],
