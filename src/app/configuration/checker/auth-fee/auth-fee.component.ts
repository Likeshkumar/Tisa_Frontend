...
@Component({
  selector: 'app-auth-fee',
  templateUrl: './auth-fee.component.html',
  styleUrls: ['./auth-fee.component.scss'],
})

export class AuthFeeComponent implements OnInit {
  ...
  InitForm() {
    this.feeForm = this.fb.group({
      ...
      ren_periodicity: [''],
      repin_periodicity: [''],
      cardblock_periodicity: [''],
      cardunblock_periodicity: [''],
      secacc_periodicity: [''],
      close_periodicity: [''],
      resetpin_periodicity: [''],
      cardpemblock_periodicity: [''],

      newcardfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      newcardtax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      newtxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      replacementcardfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      replacementcardtax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      replacementtxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      renewalcardfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      renewalcardtax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      renewaltxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],


      repincardfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      repintax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      repintxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],


      cardblockfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      cardblocktax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      cardblocktxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],


      cardunblockfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      cardunblocktax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      cardunblocktxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      secaccountfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      secaccounttax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      secaccounttxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      carddesfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      carddestax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      carddestxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      resetpinfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      resetpintax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      resetpintxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],

      cardpemblockfee: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(5)]],
      cardpemblocktax: ['', [Validators.pattern('^[0-9]*$'), Validators.maxLength(4)]],
      cardpemblocktxncode: ['', [Validators.pattern('^[A-Z]*$'), Validators.maxLength(3)]],
    });
  }
  ...
  getFeeList() {
    this.spinner.show();
    this.rest.getwithHeader('get/fee/getAuthlist').subscribe(
      res => {
        if (res.respCode == "00") {
          this.spinner.hide();
