...
@Component({
  selector: 'app-auth-pre-generation',
  templateUrl: './auth-pre-generation.component.html',
  styleUrls: ['./auth-pre-generation.component.scss'],
  providers: [DatePipe]
})


export class AuthPreGenerationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.noncpckitprocode = this.rest.noncpckitprocesscodeAuth;
    this.getProductData();
    this.getBranchData();
  }
  ...
  getFilterRecordList() {
    ...
    let url = 'instant/encoding/authprelist';
  ...
  authorizePreFile() {
    ...
    let url = 'instant/encoding/authorize';
    this.rest.postValidate(reqData, url).subscribe((res: any) => {
  ...
  rejectPreFile() {
    ...
    let url = 'instant/encoding/rejectAuthorize';
    this.rest.postValidate(reqData, url).subscribe((res: any) => {
