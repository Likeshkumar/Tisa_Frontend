...
@Component({
  selector: 'app-cvv-generation',
  templateUrl: './cvv-generation.component.html',
  styleUrls: ['./cvv-generation.component.scss'],
  providers: [DatePipe]
})


export class CvvGenerationComponent implements OnInit {
  ...
  getFilterRecordList() {
    ...
    let url = 'instant/auth/get/cvv-list';
